...
function setupEventListeners() {
    ...
    document.getElementById('saveRecordBtn').addEventListener('click', async () => {
        ...
        try {
            ...
            await postMessageToSlack(`Uma nova deligência foi criada: ID: ${recordData.record_id}, Provedor: @${providerName}, Status: ${recordData.status}, Prioridade: ${recordData.priority}`);
